...
![image](https://github.com/alexlopezprofe/SOM/assets/148449360/45ccbe7d-d1f5-43c6-91d9-a1a4c9564368)
...
La memoria se divide en un cierto número de particiones o zonas, cada una de las cuales contendrá un proceso. El tamaño de cada una de las particiones es determinado por un operador humano o por el sistema operativo y el tamaño de cada una de las particiones puede ser diferente.
